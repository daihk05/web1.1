<?php
    class post{
        static $post_id = 0;
        static function get_my_posts( $author, $status = 'any'){
...
<?php
        ...
        ?>
            <!-- post -->
            <article id="post-<?php echo $post -> ID; ?>" <?php post_class( 'post stickem-container' . $classes , $post -> ID ); ?>>
                ...
                <header class="entry-header">
                    ...
                    ?>
                                <div class="love">
                                    ...
                                    <div class="face-like">
                                        <div class="fb-like" data-href="<?php echo get_permalink( $post -> ID );?>" data-layout="box_count" data-action="like" data-show-faces="false" data-share="false"></div>
                                    </div>
                                    <div class="post-view">
                                        <div class="common-khung">
                                            <?php echo getPostViews($post->ID); ?>
                                        </div>
                                        <div class="common-countbox">
                                            <s></s>
                                            <i></i>
                                        </div>
                                        <img src="<?php echo get_template_directory_uri().'/images/view.png'?>" alt="post-view" />
                                    </div>

                                    <div class="face-comments">
                                        <div class="common-khung">
                                            <a href="<?php echo get_comments_link( $post -> ID ) ?>"> <fb:comments-count href="<?php echo get_permalink( $post -> ID ) ?>"></fb:comments-count> </a>
                                        </div>
                                        <div class="common-countbox">
                                            <s></s>
                                            <i></i>
                                        </div>
                                        <img src="<?php echo get_template_directory_uri().'/images/comment.png'?>" alt="face-comments" />
                                    </div>
                                    </div>
                ...
                ?>
                        ...
                        <div class="entry-content">
                            <div class="featimg readmore" <?php if(isset($onclick)){ echo "onclick=".$onclick; }?> >
                                <?php $tmp_gif = get_featured_img($post->ID);?>
                                <div class="<?php if ($tmp_gif[4] != 'gif'){ echo 'img';} else {echo 'img-gif';}?>">
                                    <?php
                                        ob_start();
                                        ob_clean();
                                        ...
                                        if( is_user_logged_in () ){
                                            ...
                                            if ($tmp_gif[4] != 'gif') {
                                    ?>
                                            <a href="<?php if(!isset($onclick)){ echo get_permalink( $post -> ID ); }else{ echo 'javascript:void(0)'; } ?>" title="<?php echo $caption;  ?>" class="mosaic-overlay 1" > <?php if(!isset($onclick)){ ?><div class="details"><?php _e( 'Read more' , 'cosmotheme' ); ?></div> <?php }?></a><?php if(isset($onclick)){ ?><div class=" play">&nbsp;</div><?php } ?> <div class="format">&nbsp;</div>
                                            <img src="<?php echo $src[0]; ?>" class="no-safe image" alt="<?php echo $caption; ?>" width="<?php echo $tmp_gif[2];?>" height="<?php echo $tmp_gif[3];?>"/>
                                            
                                    <?php 
                                            } else {
                                    ?>
                                           <div class="badge-animated-container-animated hide">
                                                <img class="badge-item-img" alt="thumbnail" src="<?php echo $tmp_gif[0];?>" width="<?php echo $tmp_gif[2];?>" height="<?php echo $tmp_gif[3];?>">
                                            </div>
                                            <div class="badge-animated-container-static gif-post">
                                                <img class="badge-item-img" alt="thumbnail" src="<?php echo $tmp_gif[1];?>" width="<?php echo $tmp_gif[2];?>" height="<?php echo $tmp_gif[3];?>">
                                    ...
                                    <?php
                                            ...
                                            if( isset( $meta['safe'] ) ){
                                                if( !meta::logic( $post , 'settings' , 'safe' ) ){
                                                    if ($tmp_gif[4] != 'gif') {
                                    ?>
                                                    <a href="<?php if(!isset($onclick)){ echo get_permalink( $post -> ID ); }else{ echo 'javascript:void(0)'; }?>" title="<?php echo $caption;  ?>" class="mosaic-overlay 2"><?php if(!isset($onclick)){ ?><div class="details"><?php _e( 'Read more' , 'cosmotheme' ); ?></div><?php } ?></a><?php if(isset($onclick)){ ?><div class="play">&nbsp;</div><?php } ?> <div class="format">&nbsp;</div>
                                    ...
                                    <?php
                                                ...
                                                if ($tmp_gif[4] != 'gif') {
                                    ?>
                                                <a href="<?php if(!isset($onclick)){ echo get_permalink( $post -> ID ); }else{ echo 'javascript:void(0)'; }?>"" title="<?php echo $caption;  ?>" class="mosaic-overlay 3"> <?php if(!isset($onclick)){ ?><div class="details"><?php _e( 'Read more' , 'cosmotheme' ); ?></div> <?php } ?></a> <?php if(isset($onclick)){ ?><div class="play">&nbsp;</div><?php } ?> <div class="format">&nbsp;</div>
                                                <img src="<?php echo $src[0]; ?>" class="no-safe image" alt="<?php echo $caption; ?>" width="<?php echo $tmp_gif[2];?>" height="<?php echo $tmp_gif[3];?>"/>
                                    <?php 
                                            } else {
                                    ?>
        ...
        ?>
            <article id="post-<?php echo $post -> ID; ?>" <?php post_class( 'col ' . $classes , $post -> ID ); ?>>
                ...
                ?>
                        <div class="readmore">
                            <?php
                                ...
                                if( is_user_logged_in () ){
                            ?>
                                    <a href="<?php echo get_permalink( $post -> ID ); ?>" title="<?php echo $caption;  ?>" class="mosaic-overlay 4" ><div class="details">&nbsp;</div></a> <div class="format">&nbsp;</div>
                            ...
                            <?php
                                    ...
                                    if( isset( $meta['safe'] ) ){
                                        if( !meta::logic( $post , 'settings' , 'safe' ) ){
                            ?>
                                            <a href="<?php echo get_permalink( $post -> ID )?>" title="<?php echo $caption;  ?>" class="mosaic-overlay 5"><div class="details">&nbsp;</div></a> <div class="format">&nbsp;</div>
                                            <img src="<?php echo $src[0]; ?>" alt="<?php echo $caption; ?>" />
                            <?php
                                        }else{
                            ...
                            ?>
                                        <a href="<?php echo get_permalink( $post -> ID )?>" title="<?php echo $caption;  ?>" class="mosaic-overlay 6"><div class="details">&nbsp;</div></a> <div class="format">&nbsp;</div>
                                        <img src="<?php echo $src[0]; ?>" alt="<?php echo $caption; ?>" />
                            <?php
                                    }
                                }
                ...
                <?php
                        ...
                        ?>
                        <div class="readmore">
                            <a href="<?php echo get_permalink( $post -> ID ); ?>" class="mosaic-overlay 7" ><div class="details">&nbsp;</div></a> <div class="format">&nbsp;</div>
        ...
        static function is_grid( $template ){
            $grid = false;
    ...
    <?php
        ...
        static function meta( $post , $nav = true ){
            global $wp_query;
        ?>
        ...
        static function get_embeded_video($video_id,$video_type,$autoplay = 0,$width = 570,$height = 450){
