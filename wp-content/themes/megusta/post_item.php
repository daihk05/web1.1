...
<div class="cosmo-tabs submit" id="d39">
	...
	<div class="tabs-container" id="pic_upload">
		...
		<?php CosmoUploader::print_form("Lựa chọn hình ảnh","image",true,true)?>
        <form method="post" action="/post-item?phase=post" id="form_post_image" >  
			<div class="field">
				<label>
					<h4><?php _e('Tiêu Đề','cosmotheme')?></h4>
			...
			<div class="field">
				<label>
					<h4><?php _e('Thư mục','cosmotheme')?></h4>
					<?php 
			...
			<div class="field">
				<label class="nsfw"> 
					<input type="checkbox" class="checkbox" <?php if(isset($action_edit_image) && meta::logic( $post_edit , 'settings' , 'safe' )){ echo 'checked'; } ?> name="nsfw" value="1"> <?php _e('Ảnh 18+ Không dành cho thanh niên nghiêm túc','cosmotheme'); ?>
	...
	<div class="tabs-container tabs-hide" id="video_upload">
			...
			<?php CosmoUploader::print_form("Chọn Video","video",true,true)?>
