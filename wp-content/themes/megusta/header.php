...
<html xmlns="http://www.w3.org/1999/xhtml" <?php language_attributes(); ?> xmlns:fb="http://www.facebook.com/2008/fbml">
    ...
    <head>
        ...
        <script src="<?php echo get_template_directory_uri(); ?>/js/jquery.cookiefixed.js" type="text/javascript" ></script>
        ...
        <script src="<?php echo get_template_directory_uri(); ?>/js/jquery.stickem.js" type="text/javascript"></script>
		<script type="text/javascript">
			jQuery(document).ready(function() {				
				jQuery('.loop-container-view').stickem();

				jQuery('.badge-animated-container-static').click(function() {
					jQuery(this).addClass('hide');
					jQuery(this).prev().removeClass('hide');
				});

				jQuery('.badge-animated-container-animated').click(function(){
					jQuery(this).addClass('hide');
        ...
        <?php
            ...
            if(get_background_image() == '' && !isset($_COOKIE["megusta_day_night"]) && trim(get_bg_image()) != ''){  
